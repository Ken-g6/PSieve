...
#
#i586-mingw32msvc-gcc -Wall -O3 -fomit-frame-pointer -DNDEBUG -D_REENTRANT -m32 -march=i686 -I. -I.. -s -o $appname-x86-windows.exe ../main.c ../sieve.c ../clock.c ../util.c app.c -lm
